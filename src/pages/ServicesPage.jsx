...
export default function ServicesPage() {
  ...
  return (
    <div ref={containerRef} className="bg-background text-on-background font-body-md overflow-x-hidden pt-16 sm:pt-20">
      {/* Hero Section */}
      ...
      {/* Services Bento Grid */}
      <main className="px-gutter max-w-container-max mx-auto pb-section-gap">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
          
          {/* Service 1: Physical Guarding (Large Feature) */}
          <div className="md:col-span-8 group relative overflow-hidden rounded-xl border border-border-subtle card-hover reveal-on-scroll" style={{ transitionDelay: '0.4s' }}>
            <img alt="Professional security personnel in high-visibility tactical gear" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 card-img brightness-[0.6] sm:brightness-[0.7] saturate-50" src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1200"/>
            <div className="absolute inset-0" style={{ background: 'linear-gradient(rgba(12, 19, 34, 0.2) 20%, rgba(12, 19, 34, 0.95) 100%)' }}></div>
            <div className="relative h-[450px] sm:h-[600px] flex flex-col justify-end p-6 sm:p-10 md:p-12">
              <div className="flex items-center space-x-3 mb-3 sm:mb-4">
                <span className="material-symbols-outlined text-primary bg-primary/10 p-2 rounded-full text-base sm:text-xl">shield</span>
                <span className="font-label-caps text-xs sm:text-label-caps text-primary-fixed tracking-wider">01 / TACTICAL OPERATIONS</span>
              </div>
              <h2 className="text-2xl sm:text-4xl md:text-display-lg font-display-lg mb-3 sm:mb-4 text-white">On-Site Guarding</h2>
              <p className="text-sm sm:text-body-md font-body-md text-on-surface-variant max-w-lg mb-6 sm:mb-8">
                Vetted, highly-trained security officers providing strict entry checking, visible deterrence, and dynamic response routines across critical environments.
              </p>
          ...
          {/* Service 2: Access Control (Vertical Feature) */}
          <div className="md:col-span-4 group relative overflow-hidden rounded-xl border border-border-subtle card-hover reveal-on-scroll" style={{ transitionDelay: '0.5s' }}>
            ...
            <div className="relative h-[400px] sm:h-[600px] flex flex-col justify-end p-6 sm:p-10 md:p-12">
              <div className="flex items-center space-x-3 mb-3 sm:mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-headline-md font-headline-md mb-3 sm:mb-4 text-white">Technical Integration</h2>
              <p className="text-sm sm:text-body-md font-body-md text-on-surface-variant mb-6">
                Biometric checkpoints and high-definition central monitoring arrays unified for absolute situational awareness.
              </p>
          ...
          {/* Service 3: Risk Assessment (Wide Feature) */}
          <div className="md:col-span-12 group relative overflow-hidden rounded-xl border border-border-subtle card-hover reveal-on-scroll" style={{ transitionDelay: '0.2s' }}>
            <img alt="Security personnel in a team briefing" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 card-img brightness-[0.5] sm:brightness-[0.7] saturate-[0.8]" src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1400"/>
            ...
            <div className="relative min-h-[400px] md:min-h-[450px] flex items-center p-6 sm:p-10 md:p-12">
              <div className="max-w-xl w-full">
                <div className="flex items-center space-x-3 mb-3 sm:mb-4">
                  <span className="material-symbols-outlined text-tertiary bg-tertiary/10 p-2 rounded-full text-base sm:text-xl">query_stats</span>
                  <span className="font-label-caps text-xs sm:text-label-caps text-tertiary tracking-wider">03 / INTELLIGENCE</span>
                </div>
                <h2 className="text-2xl sm:text-4xl md:text-display-lg font-display-lg mb-3 sm:mb-4 text-white">Risk Management &amp; Audit</h2>
                <p className="text-sm sm:text-body-md font-body-md text-on-surface-variant mb-6 sm:mb-8">
                  Comprehensive vulnerability scans and preventative site planning to pinpoint and fix gaps in your enterprise perimeter defense layout.
                </p>
      ...
      <section className="py-16 sm:py-section-gap px-gutter bg-surface-container-lowest overflow-hidden relative">
        ...
        <div className="max-w-container-max mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 sm:gap-16 md:gap-24 items-center">
            ...
            {/* Visual Dashboard Card - Enhanced for mobile scaling */}
